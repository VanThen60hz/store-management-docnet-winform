...
namespace QuanLyBanHang.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = E:\.net\winform\QuanLyBanHang\QuanLyBanHang\Quanlybanhang.mdf; Integrated Security = True";
            Con.Open();
        ...
        public static string ChuyenSoSangChu(string sNumber)
        {
            ...
            {
                // Kiểm tra độ dài chuỗi trước khi truy cập
                if (i < sNumber.Length)
                {
                ...
                {
                    break; // Thoát vòng lặp nếu chuỗi rỗng
                }
                ...
                switch ((mLen - i) % 9)
                {
                    case 0:
                        ...
                        {
                            next3Char = sNumber.Substring(i + 1, 3);
                        }
                        else
                        {
                            next3Char = "";
